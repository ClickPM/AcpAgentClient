...
fn parse_request(method: &str, params: &Value) -> Result<(), String> {
    match method {
        ...
        // R6 会话生命周期。
        "session/list" => cast::<acp::ListSessionsRequest>(params),
        "session/load" => cast::<acp::LoadSessionRequest>(params),
        "session/resume" => cast::<acp::ResumeSessionRequest>(params),
        "session/close" => cast::<acp::CloseSessionRequest>(params),
        "session/delete" => cast::<acp::DeleteSessionRequest>(params),
...
fn parse_response(method: &str, result: &Value) -> Result<(), String> {
    match method {
        ...
        "session/list" => cast::<acp::ListSessionsResponse>(result),
        "session/load" => cast::<acp::LoadSessionResponse>(result),
        "session/resume" => cast::<acp::ResumeSessionResponse>(result),
        "session/close" => cast::<acp::CloseSessionResponse>(result),
        "session/delete" => cast::<acp::DeleteSessionResponse>(result),
