...
> 设计稿已于 2026-09-14 收口（40 张画板；2026-09-17 增画板 05「转场规格」、2026-09-18 增画板 06「侧栏会话活动指示」、2026-09-20 增画板 43「会话时间线」与 07「深色 Token 对位表」、2026-09-22 增画板 08「交互增强」，现 45 张（含已废弃的 10）。清单与计数以 [`design/README.md`](design/README.md) 为准），本文据此把实现拆成 **R0–R8（含 R1.5 spike）**，取代 `docs/design.md` § 11 的草案（2026-09-15）。
