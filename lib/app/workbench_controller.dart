...
class WorkbenchController extends ChangeNotifier {
  ...
  /// 侧栏底部导航的选中项：终端标签活着时是「终端」。
  ShellTab? get navActiveTab => activeTerminalId != null && terminals.byId(activeTerminalId!) != null ? ShellTab.terminal : rightTab;

  /// 侧栏底部导航：文件 / Agents / 设置开对应面板；终端开一个本地 shell 标签（已有就切到最近那个）。
